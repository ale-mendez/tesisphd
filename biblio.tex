...
%%% Asymptotic behaviour HF orbitals %%%
...
\bibitem{Berrington:74}
K. A. Berrington, P. G. Burke, J. J. Chang, A. T. Chivers, W. D. 
Robband, K. T. Taylor
%A general program to calculate atomic continuum processes using the R-matrix method
Comput. Phys. Commun. \textbf{8} 149 (1974).

\bibitem{Berrington:95}
K. A. Berrington,  W. B. Eissner, P. H. Norrington,
%\textsc{rmatrx1}: Belfast atomic R-matrix codes, 
Comp. Phys. Comm. \textbf{92} 290 (1995).
