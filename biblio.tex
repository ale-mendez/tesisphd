...
En \textit{At. Mol. Process} Vol.~13.
Pure and Applied Physics; Elsevier, 1962.
...
J Atom. Mol. Opt. Phys. \textbf{2010}, 604572 (2010).
...
%The time-dependent close-coupling method for  atomic and molecular 
%collision processes.
...
\textit{Physics of atoms and molecules}, 2da edición.
Pearson Education Limited, Harlow, Inglaterra, 2003.

\bibitem{Cowan:81}
R. D. Cowan,
\textit{The Theory of Atomic Structure and Spectra}, 1ra edición.
University of California Press. Berkeley, Estados Unidos, 1981.

%%%% Potenciales %%%% 

\bibitem{Hibbert:82}
A. Hibbert,
\textit{Advances in atomic and molecular physics}, Vol. 18.
Eds: D. Bates, B. Bederson. 
Elsevier Science \& Technology Books, 1982.

\bibitem{Gombas:56}
P. Gombás, 
Handb. Phys. \textbf{36}, 109--231 (1956).
...
\textit{Atomic Structure Calculations}. 
...
\bibitem{Menchero:10}
L. Fernández--Menchero, S. Otranto, 
Phys. Rev. A {\bf 82}, 022712 (2010).

\bibitem{Granados:16}
C. M. Granados--Castro, 
\textit{Application of Generalized Sturmian Basis Functions to
Molecular Systems}. Tesis de Doctorado.
...
J. I. Di Filippo,
\textit{Métodos de Aprendizaje Automático para la obtención de 
Potenciales Efectivos Atómicos}. Tesis de Licenciatura, Universidad de 
Buenos Aires, 2019.
...
En \textit{Theory Appl. Comput. Chem.}; 
...
Optika i spektr. \textbf{17}, 234 (1964).

\bibitem{Henke:82}
B. L. Henke, P. Lee, T. J. Tanaka, R. L. Shimabukuro, B. K. Fujikawa, 
At. Data Nucl. Data Tables \textbf{27}, 1--144 (1982).

\bibitem{Samson:89}
J. A. R. Samson, G. N. Haddad, T. Masuoka, P. N. Pareek, 
D. A. L. Kilcoyne, 
J. Chem. Phys. \textbf{90}, 6925--6932 (1989).
...
Phys. Rev. A \textbf{28}, 3244--3257 (1983).
...
\bibitem{Amusia:04}
M.Ya. Amusia, A.Z. Msezane, V.R. Shaginyan, D. Sokolovski, 
%``On the relation between the Hartree--Fock and Kohn--Sham
%approaches'',
Phys. Lett. A \textbf{330}, 10 (2015).
...
%``Large $r$ approximation for spherically averaged momentum 
%distributions'',
...
\bibitem{Solov:09}
A. V. Solov'yov, E. Surdutovich, E. Scifoni, I. Mishustin, W. Greiner, 
...
% \textit{Case Study of Heavy Metal Pollution in Water of Bone River by 
%Artisanal Small-Scale Gold Mine Activities in Eastern Part of Gorontalo, 
%Indonesia}, 
...
% \textit{Genetic damage in soybean workers exposed to pesticides: 
%Evaluation with the comet and buccal micronucleus cytome assays},
Mutat. Res. \textbf{752}, 28--33 (2013).
...
Phys. Med. Biol. \textbf{53}, N41-N51 (2008).

\bibitem{Lekadir:09}
H. Lekadir, I. Abbas, C. Champion, O. Fojón, R. D. Rivarola, J. Hanssen,
Phys. Rev. A \textbf{79}, 062710 (2009).
...
%Ionization of the He, Ne, Ar, Kr, and Xe isoelectronic series by proton 
%impact. 
Phys Rev A \textbf{78}, 052705 (2008).

\bibitem{Miraglia:09} 
J. E. Miraglia, 
%Ionization of He, Ne, Ar, Kr, and Xe by proton impact: Single 
%differential distributions. 
Phys. Rev. A \textbf{79}, 022708 (2009).

\bibitem{Montanari:17-iongasesnobles} 
C. C. Montanari, J. E. Miraglia,
%Ionization probabilities of Ne, Ar, Kr, and Xe by proton impact for 
%different initial states and impact energies. 
...
%Ionization of uracil in collisions with highly charged carbon and 
%oxygen ions of energy 100 keV to 78 MeV. 
...
O. Fojon, C. Tribedi, 
%Absolute total ionization cross sections of uracil 
%(C$_4$H$_4$N$_2$O$_2$) in collisions with MeV energy highly charged 
%carbon, oxygen and fluorine ions
...
\bibitem{Miraglia:19} 
J. E. Miraglia,
%Shell-to-shell ionization cross sections of antiprotons, H$^{+}$, 
%He$^{2+},$ Be$^{4+},$ C$^{6+}$ and O$^{8+}$ on H, C, N, O, P, and S 
%atoms,
...
%Ionization of biomolecular targets by ion impact: input data for 
%radiobiological applications. 
J. Phys.: Conf. Ser. \textbf{438}, 012015 (2013).

\bibitem{Rudd:92} 
M. E. Rudd, Y.-K. Kim,, D. H. Madison, T. J. Gay,
%Electron production in proton collisions with atoms and molecules: 
...
Nucl. Instrum. Methods Phys. Res., B \textbf{212}, 110--117 (2003).
...
\bibitem{Sens:20}
Nicolas Sens, 
\textit{Développement d’une méthode de type `velocity map imaging' pour 
la mesure de sections efficaces d’émission d’électrons par des molécules 
d’intérêt biologique en collision avec des ions}. Tesis de Doctorado,
...
\bibitem{mozejko2003}
P. Mozejko, L. Sanche, 
%Cross section calculations for electron scattering from DNA and RNA 
%bases.
...
\bibitem{sarkadi2016}
L. Sarkadi, 
%Classical trajectory Monte Carlo model calculations for ionization of 
%the uracil molecule by impact of heavy ions
J. Phys. B \textbf{49}, 185203 (2016).

\bibitem{wolff2014}
W. Wolff, H. Luna, L. Sigaud, A. C. Tavares, E. C. Montenegro,
%Absolute total and partial dissociative cross sections of pyrimidine at 
%electron and proton intermediate impact velocities
...
%Electron emission from proton --hydrocarbon-molecule collisions at 
%0.3--2.0 MeV. 
...
%Excitation and ionisation cross-section in condensed-phase 
%biomaterials by electrons down to very low energy: application to 
%liquid water and genetic building blocks
Phys. Chem. Chem. Phys., \textbf{23}, 5079--5095 (2021).
...
E. C. Montenegro, G. M. Sigaud, R. D. DuBois, 
Phys. Rev. A \textbf{87}, 012706 (2013).

% H+ in CH4
\bibitem{Luna2019} 
H. Luna, W. Wolff, E. C. Montenegro, L. Sigaud, 
...
Debelle, E. Wendler, 
%Defects and mechanical properties in weakly damaged Si ion implanted 
%GaAs,
...
\bibitem{Mayer:20}
M. Mayer, S. M\"oller, M. Rubel \textit{et al.}, 
%Ion beam analysis of fusion plasma-facing materials and components: 
%Facilities and research challenges, 
Nucl. Fusion \textbf{60}, 025001 (2020).

\bibitem{He:17}
B. He, X. J. Meng, Z. G. Wang \textit{et al.}, 
%Ab initio research of energy loss for energetic protons in 
%solid-density Be, 
Phys. Plasmas \textbf{24}, 033110 (2017).

\bibitem{AlcocerAvila:19}
M. E. Alcocer-Ávila, M. A. Quinto, J. M. Monti \textit{et al.},
%Proton transport modeling in a realistic biological environment by 
%using TILDA - V , 
Sci. Rep. \textbf{9}, 14030 (2019).

\bibitem{Vera:19}
P. de Vera, R. Garcia-Molina, I. Abril, 
%Simulation of the energy spectra of swift light ion beams after 
%traversing cylin-drical targets: A consistent interpretation of 
%experimental data relevant for hadron therapy, 
...
Stopping of Swift Point Charges}, Vol. 151.
Springer Series en Solid-State Sciences, Springer, Berlin, 2006.
...
``Rare-Earths and Actinides in High Energy Spectroscopy''. En
\textit{Progress in Theoretical Chemistry and Physics}. Springer, 2015.
...
Nucl. Instrum. Methods Phys. Res. B \textbf{4}, 337 (1984).
...
%The effects of coupling to the target continuum on the electron-impact 
%excitation of Li+, 
J. Phys. B \textbf{36}, 235--246 (2003).

\bibitem{Badnell:03}
N. R. Badnell, D. C. Griffin, D. M. Mitnik, 
%Electron-impact excitation of B+ using the R-matrix with pseudo-states 
%method, 
J. Phys. B \textbf{36}, 1337--1350 (2003).

\bibitem{Mitnik:03}
D. M. Mitnik, D. C. Griffin, C. P. Ballance, N. R. Badnell, 
%An R-matrix with pseudo-states calculation of electron-impact 
%excitation in C2+, 
...
processes.'' En \textit{Stellar Clusters and Associations: Convection, 
Rotation, and Dynamos}, vol. 198, p. 235 (2000).
...
%R-matrix electron-impact excitation cross sections in intermediate 
%coupling: an MQDT transformation approach, 
...
\textit{Numerical Recipes: The Art of Scientific Computing}, 3ra Ed. 
2007.
...
\bibitem{Barber:12}
D. Barber, 
\textit{Bayesian Reasoning and Machine Learning}, 
Cambridge University Press, 2012.

\bibitem{Bergstra:11}
J. S. Bergstra, R. Bardenet, Y. Bengio, B. Kégl, 
``Algorithms for Hyper-Parameter Optimization'' en 
\textit{Advances in Neural Information Processing Systems} 24. 
Eds: J. Shawe-Taylor, R. S. Zemel, 
P. L. Bartlett, F. Pereira, K. Q. Weinberger, Curran Associates Inc., 
pp. 2546--2554, 2011.
