...
%                   & Talio   & Ta & 73 & [Xe]~$4f^{14}\,5d^3\,6s^2$ \\
...
tabla~\ref{tab:gruposrelat} obtenidos a partir de la optimización de los
blancos se dan en la tabla~\ref{tab:relatresults}. Los valores medios 
orbitales $\langle r \rangle$, dados por la ecuación~(\ref{eq:meanvalr}), 
también se dan en la tabla. Los presentes cálculos teóricos de energías 
de ligadura se muestran en la figura~\ref{fig:bindener} con círculos
...
\begin{figure}[t]
\centering
%\includegraphics[width=0.9\textwidth]{heavy/bindenerA.eps} \\
%\includegraphics[width=0.9\textwidth]{heavy/bindenerB.eps}
\includegraphics[width=0.9\textwidth]{heavy/bindener.eps}
...
\cite{Desclaux:73} (símbolos $\times$) y data experimental
...
\hline
\multirow{2}{*}{$nljm$} & $E^{\mbox{\tiny expt}}$ & $E^{\mbox{\tiny th}}$ & $\langle r \rangle^{\mbox{\tiny th}}$ &
