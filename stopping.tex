...
Para energías de impacto superiores a unos pocos keV/amu, las 
...
presencia en la corteza superior de la Tierra. % tierras raras
...
%El paquete de códigos {\sc hullac}~\cite{BarShalom:01} fue implementado para resolver numéricamente la ecuación de Dirac. En este conjunto de programas computacionales, el código {\sc relac} es permite calcular las energías y funciones de onda orbitales en primer orden usando el método potencial paramétrico. Este método combina el primer orden de la teoría de perturbaciones independiente del tiempo con la aproximación de campo central, lo que permite escribir el Hamiltoniano $H'$ como un término sin perturbar
%\begin{equation}
% H_0 = \sum_i h_i^{\mbox{\scriptsize D}} + U(r_i)\,,
%\end{equation}
%más una perturbación de primer orden
%\begin{equation}
% H_1 = \sum_{i<j}\frac{1}{r_{ij}}
% - \sum_i \left[ \frac{Z}{r_i} + U(r_i) \right]\,,
%\end{equation}
%mientras que los términos de Breit y los efectos QED se incluyen a las energías como perturbaciones de segundo orden. El potencial paramétrico $U(r_i)$ describe de manera simple el apantallamiento de la distribución de carga de los electrones y es determinado minimizando las energías de configuración promedio (\acs{ac}) de primer orden. El método de potencial paramétrico se implementa dentro del esquema de interacción de configuraciones (\acs{ci}), es decir, el potencial se minimiza para diferentes grupos de configuraciones, agrupados por energías similares y de igual paridad. A continuación, el hamiltoniano $H'$ se construye a partir de configuraciones mixtas incluidas en el cálculo de $U(r_i)$, lo que permite tener en cuenta los efectos de correlación. 
...
Los efectos de la interacción de configuraciones son muy importantes 
...
The agreement between the present theoretical results and the
...
\begin{figure}[h]
\centering
 \includegraphics[width=0.70\textwidth]{heavy/bindenerA.eps} \\
 \vspace{0.075\textheight}
 \includegraphics[width=0.70\textwidth]{heavy/bindenerB.eps}
...
\begin{figure}[h]
\centering
 \includegraphics[width=0.70\textwidth]{heavy/bindenerC.eps} \\
 \vspace{0.075\textheight}
 \includegraphics[width=0.70\textwidth]{heavy/bindenerE.eps}
\caption{Present theoretical relativistic binding energies
(filled symbols), Dirac--Fock relativistic results \cite{Desclaux:73}
($\times$ symbols) and experimental values \cite{expdata} (hollowed 
...
\begin{figure}
 \centering
 \includegraphics[width=0.70\textwidth]{heavy/ratios_exp.eps}
...
\begin{comment}
\begin{tabularx}{\textwidth}{@{}Y|YYY|YYY|YYY@{}}
\caption{Present theoretical and experimental \cite{expdata} 
electron binding energies and $\langle r \rangle$ values in a.u. 
of Zr, Nb, Pd, Gd, Er, Hf, Ta, Os and Pt.}
\label{tab:tab1}\\
\hline
$nljm$ & $E^{\mbox{\tiny expt}}$ & $E^{\mbox{\tiny th}}$ & $\langle r \rangle^{\mbox{\tiny th}}$ &
   ...
   $E^{\mbox{\tiny expt}}$ & $E^{\mbox{\tiny th}}$ & $\langle r \rangle^{\mbox{\tiny th}}$ \\
\endfirsthead
\caption*{Table 1 (Cont.): Present theoretical and experimental 
\cite{expdata} electron binding energies and $\langle r \rangle$ 
values in a.u. of Zr, Nb, Pd, Gd, Er, Hf, Ta, Os and Pt.} \\
\hline
$nljm$ & $E^{\mbox{\tiny expt}}$ & $E^{\mbox{\tiny th}}$ & $\langle r \rangle^{\mbox{\tiny th}}$ &
   $E^{\mbox{\tiny expt}}$ & $E^{\mbox{\tiny th}}$ & $\langle r \rangle^{\mbox{\tiny th}}$ &
   $E^{\mbox{\tiny expt}}$ & $E^{\mbox{\tiny th}}$ & $\langle r \rangle^{\mbox{\tiny th}}$ \\
...
\cline{2-10}
$1s$  & 661.40 & 651.34 & 0.0372 & 697.71 & 685.57 & 0.0362 & 894.83 & 880.77 & 0.032 \\
...
$3d^-$ & 6.656  & 6.505  & 0.450  & 7.53   & 7.41   & 0.431  & 12.51  & 11.98  & 0.359 \\
...
\hline
\hline
       &  \multicolumn{3}{c}{Gd} & \multicolumn{3}{c}{Er} & \multicolumn{3}{c}{Hf} \\
\cline{2-10}$1s$  & 1846.2 & 1834.6 & 0.0220 & 2112.5 & 2114.2 & 0.0203 & 2401.6 & 2400.4 & 0.0190 \\
$2s$  & 307.8  & 303.1  & 0.0927 & 358.3  & 353.7  & 0.0859 & 414.19 & 408.98 & 0.0798 \\
