...
%%%% Resultados de 100 minimización 
\begin{figure}
\includegraphics[width=0.9\textwidth]{figures/rmatrix/OptIII_Jpol.eps}
...
\end{figure}
\begin{figure}
\includegraphics[width=0.9\textwidth]{figures/rmatrix/OptIII_params.eps}
...
%%%% Resultados de 1 minimización (la mejor)
\begin{figure}
\includegraphics[width=0.9\textwidth]{figures/rmatrix/OptIII_Jpol_globmin.eps}
...
\end{figure}
\begin{figure}
\includegraphics[width=0.9\textwidth]{figures/rmatrix/OptIII_params_globmin.eps}
