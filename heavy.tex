\chapter{Pérdida de energía en átomos pesados: la descripción relativista}
\label{chap:heavy}
...
La aproximación más conocida para resolver la Ec.~(\ref{eq:HDirac}), y 
...
Por otro lado, el análisis de la estructura de los lantánidos arroja 
...
%Las predicciones teóricas del modelo combinado relativista difiere del 
...
%cualquier descripción teórica. 
%Esta característica se puede apreciar en la figura, donde el eje $y$ se 
%muestra con escala lineal. 
...
%Por otro lado, a energías por debajo del máximo, la curva \textsc{casp} 
%tiene un comportamiento completamente diferente. 
...
En este Capítulo se estudió la estructura de nueve blancos pesados con 
